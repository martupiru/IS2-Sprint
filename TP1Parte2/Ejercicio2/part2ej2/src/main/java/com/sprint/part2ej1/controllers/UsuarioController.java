...
public class UsuarioController {
    ...
    public String mostrarDashboard(HttpSession session, Model model) {
        ...
        List<String> datosDolar = dolarService.obtenerCompraVentaFecha();

        if (!datosDolar.isEmpty()) {
            model.addAttribute("compra", datosDolar.get(0));
            model.addAttribute("venta", datosDolar.get(1));
            model.addAttribute("fecha", datosDolar.get(2));
        }
